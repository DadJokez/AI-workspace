      ...
      <ul className="flex flex-col gap-1">
        {versions.map((version) => (
          <li
            ...
            className="flex items-start justify-between gap-3 rounded-md border border-hairline px-3 py-2 text-[12px]"
          >
            <div className="min-w-0">
              <div className="flex flex-wrap items-center gap-1.5 text-ink">
                ...
                {version.isLive ? (
                  <span className="rounded bg-ink/10 px-1.5 py-0.5 text-[10px] font-medium uppercase tracking-wide text-ink">
                    Live
                  </span>
                ) : (
                  <span className="rounded bg-ink/5 px-1.5 py-0.5 text-[10px] uppercase tracking-wide text-muted">
            ...
            <div className="flex shrink-0 items-center gap-2">
              <a
                ...
                className="rounded-md border border-hairline px-2.5 py-1 text-[12px] text-ink hover:bg-ink/5"
              >
                Preview
              </a>
              {canDeploy && version.canDeploy ? (
                <button
                  ...
                  className="rounded-md border border-hairline px-2.5 py-1 text-[12px] font-medium text-ink hover:bg-ink/5 disabled:opacity-50"
                >
              ...
              {version.canDiscard ? (
                <button
                  ...
                  className="rounded-md border border-hairline px-2.5 py-1 text-[12px] text-muted hover:text-ink disabled:opacity-50"
                >
                  Discard
                </button>
              ) : null}
