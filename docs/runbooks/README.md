...
| [ADD_A_CONVERSE_MODEL.md](./ADD_A_CONVERSE_MODEL.md) | Register, qualify and (Rob) enable a new Bedrock Converse model | **Partly — through qualification on `nova-pro` (2026-09-05) and seven of the ten-model gaggle of 2026-09-06 (three Claude 5.x entries are account-gated); the enablement flip never** |
